...
import { Sparkles, Image, Video, Home, Music, History, LogIn, UserPlus, LogOut, User, Menu, X, Activity, Coins, Gift, Code } from 'lucide-react'
...
export default function Layout({ children }: LayoutProps) {
  ...
  const navItems = [
    ...
    { path: '/vba-generator', label: 'VBA Generator', icon: Code },
