...
const tools = [
  {
    id: 'nano-banana',
    name: 'Nano Banana',
    description: 'Tạo hình ảnh sắc nét 2K với khả năng upscale 4K thông minh và hiển thị văn bản chính xác',
    credits: 4,
    category: 'image',
  ...
  },
  {
    id: 'seedream',
    name: 'Seedream 4.5',
    description: 'Tạo hình ảnh 4K với khả năng chỉnh sửa chính xác và đầu ra nhiều hình ảnh nhất quán',
    credits: 3.5,
    category: 'image',
    provider: 'ByteDance',
    featured: true,
    ...
    <div className="fade-in">
      <section className="text-center py-12 md:py-20">
        <div className="flex items-center justify-center gap-2 mb-4">
          ...
          <span className="text-indigo-400 font-medium">Powered by KIE AI</span>
        </div>
      ...
      <section className="py-12">
        <div className="glass rounded-2xl p-8 text-center">
          <h2 className="text-2xl md:text-3xl font-bold mb-4">Tại sao chọn KIE AI Tools?</h2>
          <div className="grid md:grid-cols-3 gap-8 mt-8">
            ...
            <div>
              ...
              <p className="text-slate-400">Sử dụng các mô hình AI hàng đầu từ Google, ByteDance, Midjourney và nhiều hơn nữa</p>
            </div>
            <div>
